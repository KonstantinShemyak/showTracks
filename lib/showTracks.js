function showTracks(startLat, startLon, zoom, tracks) {
  ...
  map.addLayer(new OpenLayers.Layer.OSM.OpenTopoMap("OpenTopoMap"));
  map.addLayer(new OpenLayers.Layer.MML("MML Peruskartta",
      [
        "https://tile1.kartat.kapsi.fi/1.0.0/peruskartta/${z}/${x}/${y}.png",
        "https://tile2.kartat.kapsi.fi/1.0.0/peruskartta/${z}/${x}/${y}.png"
      ],
      {
        numZoomLevels: 21,
